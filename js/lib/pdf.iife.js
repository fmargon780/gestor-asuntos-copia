(() => {
  ...
  const e = !("object" != typeof process || process + "" != "[object process]" || process.versions.nw || process.versions.electron && process.type && "browser" !== process.type);
  const i = [1, 0, 0, 1, 0, 0];
  ...
  const c = 128;
  const u = 256;
  const p = { DISABLE: 0, ENABLE: 1, ENABLE_FORMS: 2, ENABLE_STORAGE: 3 };
  const g = { DISABLE: -1, NONE: 0, FREETEXT: 3, HIGHLIGHT: 9, STAMP: 13, INK: 15 };
  const m = { RESIZE: 1, CREATE: 2, FREETEXT_SIZE: 11, FREETEXT_COLOR: 12, FREETEXT_OPACITY: 13, INK_COLOR: 21, INK_THICKNESS: 22, INK_OPACITY: 23, HIGHLIGHT_COLOR: 31, HIGHLIGHT_DEFAULT_COLOR: 32, HIGHLIGHT_THICKNESS: 33, HIGHLIGHT_FREE: 34, HIGHLIGHT_SHOW_ALL: 35, DRAW_STEP: 41 };
  const f = { PRINT: 4, MODIFY_CONTENTS: 8, COPY: 16, MODIFY_ANNOTATIONS: 32, FILL_INTERACTIVE_FORMS: 256, COPY_FOR_ACCESSIBILITY: 512, ASSEMBLE: 1024, PRINT_HIGH_QUALITY: 2048 };
  const b = 0;
  const A = 1;
  const w = 2;
  const v = 3;
  const y = 3;
  const x = 4;
  const _ = { GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3 };
  const E = 1;
  const S = 2;
  const C = 3;
  const T = 4;
  ...
  const j = 4;
  const W = 5;
  const q = { ERRORS: 0, WARNINGS: 1, INFOS: 5 };
  const X = { dependency: 1, setLineWidth: 2, setLineCap: 3, setLineJoin: 4, setMiterLimit: 5, setDash: 6, setRenderingIntent: 7, setFlatness: 8, setGState: 9, save: 10, restore: 11, transform: 12, moveTo: 13, lineTo: 14, curveTo: 15, curveTo2: 16, curveTo3: 17, closePath: 18, rectangle: 19, stroke: 20, closeStroke: 21, fill: 22, eoFill: 23, fillStroke: 24, eoFillStroke: 25, closeFillStroke: 26, closeEOFillStroke: 27, endPath: 28, clip: 29, eoClip: 30, beginText: 31, endText: 32, setCharSpacing: 33, setWordSpacing: 34, setHScale: 35, setLeading: 36, setFont: 37, setTextRenderingMode: 38, setTextRise: 39, moveText: 40, setLeadingMoveText: 41, setTextMatrix: 42, nextLine: 43, showText: 44, showSpacedText: 45, nextLineShowText: 46, nextLineSetSpacingShowText: 47, setCharWidth: 48, setCharWidthAndBounds: 49, setStrokeColorSpace: 50, setFillColorSpace: 51, setStrokeColor: 52, setStrokeColorN: 53, setFillColor: 54, setFillColorN: 55, setStrokeGray: 56, setFillGray: 57, setStrokeRGBColor: 58, setFillRGBColor: 59, setStrokeCMYKColor: 60, setFillCMYKColor: 61, shadingFill: 62, beginInlineImage: 63, beginImageData: 64, endInlineImage: 65, paintXObject: 66, markPoint: 67, markPointProps: 68, beginMarkedContent: 69, beginMarkedContentProps: 70, endMarkedContent: 71, beginCompat: 72, endCompat: 73, paintFormXObjectBegin: 74, paintFormXObjectEnd: 75, beginGroup: 76, endGroup: 77, beginAnnotation: 80, endAnnotation: 81, paintImageMaskXObject: 83, paintImageMaskXObjectGroup: 84, paintImageXObject: 85, paintInlineImageXObject: 86, paintInlineImageXObjectGroup: 87, paintImageXObjectRepeat: 88, paintImageMaskXObjectRepeat: 89, paintSolidColorImageMask: 90, constructPath: 91, setStrokeTransparent: 92, setFillTransparent: 93 };
  const K = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
  let Y = q.WARNINGS;
  ...
  const J = Array.from(Array(256).keys(), ((t2) => t2.toString(16).padStart(2, "0")));
  class Util {
  ...
  class PageViewport {
    ...
    clone({ scale: t2 = this.scale, rotation: e2 = this.rotation, offsetX: i2 = this.offsetX, offsetY: s2 = this.offsetY, dontFlip: n2 = false } = {}) {
      return new PageViewport({ viewBox: this.viewBox.slice(), userUnit: this.userUnit, scale: t2, rotation: e2, offsetX: i2, offsetY: s2, dontFlip: n2 });
    }
...
`);
  ...
  class EditorToolbar {
    ...
    constructor(t2) {
      this.#a = t2;
      EditorToolbar.#l ||= Object.freeze({ freetext: "pdfjs-editor-remove-freetext-button", highlight: "pdfjs-editor-remove-highlight-button", ink: "pdfjs-editor-remove-ink-button", stamp: "pdfjs-editor-remove-stamp-button" });
    }
    render() {
      ...
      t2.addEventListener("pointerdown", EditorToolbar.#h, { signal: e2 });
    ...
    #d() {
      ...
      i2.className = "delete";
      i2.tabIndex = 0;
      i2.setAttribute("data-l10n-id", EditorToolbar.#l[t2]);
      this.#p(i2);
    ...
    async #x(t2, e2) {
      ...
      try {
        ...
        if ("image/svg+xml" === t3.type) {
          const e3 = ImageManager._isSVGFittingCanvas, s2 = new FileReader(), n2 = new Image(), a2 = new Promise(((t4, a3) => {
            n2.onload = () => {
              i2.bitmap = n2;
              i2.isSvg = true;
              t4();
  ...
  class ColorManager {
    ...
    convert(t2) {
      ...
      for (const [t3, i2] of this._colors) if (i2.every(((t4, i3) => t4 === e2[i3]))) return ColorManager._colorsMapping.get(t3);
      return e2;
    }
    getHexCode(t2) {
  ...
  class AnnotationEditorUIManager {
    ...
    static get _keyboardManager() {
      const t2 = AnnotationEditorUIManager.prototype, arrowChecker = (t3) => t3.#pt.contains(document.activeElement) && "BUTTON" !== document.activeElement.tagName && t3.hasSomethingToControl(), textInputChecker = (t3, { target: e3 }) => {
    ...
    keydown(t2) {
      ...
      this.#at === g.NONE || this.isEditorHandlingKeyboard || AnnotationEditorUIManager._keyboardManager.exec(this, t2);
    }
    keyup(t2) {
  ...
  class AltText {
    ...
    constructor(t2) {
      ...
      AltText.#qt ||= Object.freeze({ added: "pdfjs-editor-new-alt-text-added-button", "added-label": "pdfjs-editor-new-alt-text-added-button-label", missing: "pdfjs-editor-new-alt-text-missing-button", "missing-label": "pdfjs-editor-new-alt-text-missing-button-label", review: "pdfjs-editor-new-alt-text-to-review-button", "review-label": "pdfjs-editor-new-alt-text-to-review-button-label" });
    }
    ...
    async render() {
      ...
      if (this.#Wt) {
        ...
        t2.setAttribute("data-l10n-id", AltText.#qt.missing);
        e2.setAttribute("data-l10n-id", AltText.#qt["missing-label"]);
      } else {
    ...
    async setGuessedText(t2) {
      if (null === this.#o) {
        this.#Vt = t2;
        this.#jt = await AltText._l10n.get("pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer", { generatedAltText: t2 });
        this.#Kt();
      }
    }
    ...
    async #Kt() {
      ...
      if (this.#Wt) {
        ...
        t2.setAttribute("data-l10n-id", AltText.#qt[this.#Xt]);
  ...
  class TouchManager {
    ...
    #oe(t2) {
      ...
      if (!this.#Yt && Math.abs(b2 - f2) <= TouchManager.MIN_TOUCH_DISTANCE_TO_PINCH) return;
      o2.touch0X = s2;
      o2.touch0Y = n2;
      o2.touch1X = a2;
      o2.touch1Y = r2;
  ...
  class AnnotationEditor {
    ...
    static get _resizerKeyboardManager() {
      const t2 = AnnotationEditor.prototype._resizeWithKeyboard, e2 = AnnotationEditorUIManager.TRANSLATE_SMALL, i2 = AnnotationEditorUIManager.TRANSLATE_BIG;
      return shadow(this, "_resizerKeyboardManager", new KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], t2, { args: [-e2, 0] }], [["ctrl+ArrowLeft", "mac+shift+ArrowLeft"], t2, { args: [-i2, 0] }], [["ArrowRight", "mac+ArrowRight"], t2, { args: [e2, 0] }], [["ctrl+ArrowRight", "mac+shift+ArrowRight"], t2, { args: [i2, 0] }], [["ArrowUp", "mac+ArrowUp"], t2, { args: [0, -e2] }], [["ctrl+ArrowUp", "mac+shift+ArrowUp"], t2, { args: [0, -i2] }], [["ArrowDown", "mac+ArrowDown"], t2, { args: [0, e2] }], [["ctrl+ArrowDown", "mac+shift+ArrowDown"], t2, { args: [0, i2] }], [["Escape", "mac+Escape"], AnnotationEditor.prototype._stopResizingWithKeyboard]]));
    }
    constructor(t2) {
    ...
    getBaseTranslation() {
      const [t2, e2] = this.parentDimensions, { _borderLineWidth: i2 } = AnnotationEditor, s2 = i2 / t2, n2 = i2 / e2;
    ...
    screenToPageTranslation(t2, e2) {
      return AnnotationEditor.#Fe(t2, e2, this.parentRotation);
    }
    pageTranslationToScreen(t2, e2) {
      return AnnotationEditor.#Fe(t2, e2, 360 - this.parentRotation);
    }
    #Le(t2) {
      switch (t2) {
        case 90: {
    ...
    #Be(t2, e2) {
      const [i2, s2] = this.parentDimensions, n2 = this.x, a2 = this.y, r2 = this.width, o2 = this.height, l2 = AnnotationEditor.MIN_SIZE / i2, h2 = AnnotationEditor.MIN_SIZE / s2, d2 = this.#Le(this.rotation), transf = (t3, e3) => [d2[0] * t3 + d2[2] * e3, d2[1] * t3 + d2[3] * e3], c2 = this.#Le(360 - this.rotation);
      ...
      let A2 = transf(...b2);
      const w2 = AnnotationEditor._round(n2 + A2[0]), v2 = AnnotationEditor._round(a2 + A2[1]);
      let y2, x2, _2 = 1, E2 = 1;
      ...
      const T2 = AnnotationEditor._round(r2 * _2), M2 = AnnotationEditor._round(o2 * E2);
      A2 = transf(...p2(T2, M2));
    ...
    #$e(t2, e2, i2) {
      ...
      if (1 === s2) return;
      const n2 = this.#Le(this.rotation), transf = (t3, e3) => [n2[0] * t3 + n2[2] * e3, n2[1] * t3 + n2[3] * e3], [a2, r2] = this.parentDimensions, o2 = this.x, l2 = this.y, h2 = this.width, d2 = this.height, c2 = AnnotationEditor.MIN_SIZE / a2, u2 = AnnotationEditor.MIN_SIZE / r2;
      s2 = Math.max(Math.min(s2, 1 / h2, 1 / d2), c2 / h2, u2 / d2);
      const p2 = AnnotationEditor._round(h2 * s2), g2 = AnnotationEditor._round(d2 * s2);
      if (p2 === h2 && g2 === d2) return;
      this.#ye ||= [o2, l2, h2, d2];
      const m2 = transf(h2 / 2, d2 / 2), f2 = AnnotationEditor._round(o2 + m2[0]), b2 = AnnotationEditor._round(l2 + m2[1]), A2 = transf(p2 / 2, g2 / 2);
      this.x = f2 - A2[0];
      this.y = b2 - A2[1];
      this.width = p2;
      this.height = g2;
    ...
    keydown(t2) {
      ...
      if (!this.#de) {
        ...
        for (const e3 of this.#de) {
          ...
          e3.setAttribute("data-l10n-id", AnnotationEditor._l10nResizer[n3]);
        }
      }
      const i2 = this.#de[0];
      let s2 = 0;
      ...
      if (n2 !== s2) {
        ...
        for (const i3 of e2) {
          ...
          i3.setAttribute("data-l10n-id", AnnotationEditor._l10nResizer[e3]);
        }
      }
      this.#Ye(0);
      this.#Ee = true;
    ...
    #qe(t2) {
      AnnotationEditor._resizerKeyboardManager.exec(this, t2);
    }
    #Xe(t2) {
  ...
  class TilingPattern {
    ...
    getSizeAndScale(t2, e2, i2) {
      const s2 = Math.max(TilingPattern.MAX_PATTERN_SIZE, e2);
  ...
  class CanvasGraphics {
    ...
    getColorN_Pattern(t2) {
      ...
      if ("TilingPattern" === t2[0]) {
        const i2 = t2[1], s2 = this.baseTransform || getCurrentTransform(this.ctx), n2 = { createCanvasGraphics: (t3) => new CanvasGraphics(t3, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, { optionalContentConfig: this.optionalContentConfig, markedContentStack: this.markedContentStack }) };
  ...
  const Tt = /* @__PURE__ */ Symbol("INTERNAL");
  ...
  class TextLayer {
    ...
    update({ viewport: t2, onBefore: e2 = null }) {
      ...
      if (i2 !== this.#Li) {
        e2?.();
        this.#Li = i2;
        const t3 = { div: null, properties: null, ctx: TextLayer.#Ki(this.#Mi) };
    ...
    #Qi(t2) {
      ...
      const o2 = Math.hypot(s2[2], s2[3]), l2 = o2 * TextLayer.#Ji(r2, this.#Mi);
      let h2, d2;
      if (0 === n2) {
        h2 = s2[4];
        d2 = s2[5] - l2;
      ...
      u2.fontSize = `${c2}${(TextLayer.#ji * o2).toFixed(2)}px)`;
      u2.fontFamily = r2;
      i2.fontSize = o2;
  ...
  const Dt = 65536;
  const kt = e ? class NodeCanvasFactory extends BaseCanvasFactory {
    _createCanvas(t2, e2) {
  ...
  const Rt = e ? class NodeCMapReaderFactory extends BaseCMapReaderFactory {
    async _fetch(t2) {
      return node_utils_fetchData(t2);
    }
  } : DOMCMapReaderFactory;
  const It = e ? class NodeFilterFactory extends BaseFilterFactory {
  ...
  const Ft = e ? class NodeStandardFontDataFactory extends BaseStandardFontDataFactory {
    async _fetch(t2) {
      return node_utils_fetchData(t2);
    }
  ...
  class PDFWorker {
    ...
    constructor({ name: t2 = null, port: e2 = null, verbosity: i2 = getVerbosityLevel() } = {}) {
      ...
      if (e2) {
        if (PDFWorker.#Ss?.has(e2)) throw new Error("Cannot use more than one PDFWorker per port.");
        (PDFWorker.#Ss ||= /* @__PURE__ */ new WeakMap()).set(e2, this);
    ...
    _initialize() {
      ...
      let { workerSrc: t2 } = PDFWorker;
      try {
        PDFWorker._isSameOrigin(window.location.href, t2) || (t2 = PDFWorker._createCDNWrapper(new URL(t2, window.location).href));
    ...
    _setupFakeWorker() {
      ...
      PDFWorker._setupFakeWorkerGlobal.then(((t2) => {
        if (this.destroyed) {
        ...
        this._port = e2;
        const i2 = "fake" + PDFWorker.#_s++, s2 = new MessageHandler(i2 + "_worker", i2, e2);
        t2.setup(s2, e2);
  ...
  const Lt = /* @__PURE__ */ Symbol("INITIAL_DATA");
  class PDFObjects {
  ...
  class InternalRenderTask {
    ...
    initializeGraphics({ transparency: t2 = false, optionalContentConfig: e2 }) {
      ...
      if (this._canvas) {
        if (InternalRenderTask.#Bs.has(this._canvas)) throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
  ...
  class FreeTextEditor extends AnnotationEditor {
    ...
    static get _keyboardManager() {
      const t2 = FreeTextEditor.prototype, arrowChecker = (t3) => t3.isEmpty(), e2 = AnnotationEditorUIManager.TRANSLATE_SMALL, i2 = AnnotationEditorUIManager.TRANSLATE_BIG;
    ...
    constructor(t2) {
      ...
      this.#tn = t2.color || FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor;
      this.#pn = t2.fontSize || FreeTextEditor._defaultFontSize;
    }
    static initialize(t2, e2) {
    ...
    static updateDefaultParams(t2, e2) {
      switch (t2) {
        case m.FREETEXT_SIZE:
          FreeTextEditor._defaultFontSize = e2;
          break;
        case m.FREETEXT_COLOR:
          FreeTextEditor._defaultColor = e2;
      }
    }
    updateParams(t2, e2) {
      switch (t2) {
    ...
    static get defaultPropertiesToUpdate() {
      return [[m.FREETEXT_SIZE, FreeTextEditor._defaultFontSize], [m.FREETEXT_COLOR, FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor]];
    }
    get propertiesToUpdate() {
    ...
    getInitialTranslation() {
      ...
      return [-FreeTextEditor._internalPadding * t2, -(FreeTextEditor._internalPadding + this.#pn) * t2];
    }
    rebuild() {
      if (this.parent) {
        super.rebuild();
    ...
    editorDivKeydown(t2) {
      FreeTextEditor._keyboardManager.exec(this, t2);
    }
    editorDivFocus(t2) {
      this.isEditing = true;
    }
    ...
    editorDivPaste(t2) {
      ...
      t2.preventDefault();
      const s2 = FreeTextEditor.#Un(e2.getData("text") || "").replaceAll(zt, "\n");
      if (!s2) return;
      ...
      if (r2.nodeType === Node.TEXT_NODE) {
        ...
        if (t3 !== this.editorDiv) {
          let e3 = l2;
          for (const i3 of this.editorDiv.childNodes) i3 !== t3 ? e3.push(FreeTextEditor.#Hn(i3)) : e3 = h2;
        }
    ...
    static async deserialize(t2, e2, i2) {
      ...
      n2.#Rn = FreeTextEditor.#Un(t2.value);
    ...
    serialize(t2 = false) {
      ...
      const e2 = FreeTextEditor._internalPadding * this.parentScale, i2 = this.getRect(e2, e2), s2 = AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#tn), n2 = { annotationType: g.FREETEXT, color: s2, fontSize: this.#pn, value: this.#Gn(), pageIndex: this.pageIndex, rect: i2, rotation: this.rotation, structTreeParentId: this._structTreeParentId };
      if (t2) return n2;
    ...
    renderAnnotationElement(t2) {
      ...
      const s2 = FreeTextEditor._internalPadding * this.parentScale;
  ...
  class FreeDrawOutliner {
    ...
    constructor({ x: t2, y: e2 }, i2, s2, n2, a2, r2 = 0) {
      ...
      this.#Wn = r2;
      this.#Zn = FreeDrawOutliner.#sa * s2;
      this.#Jn = FreeDrawOutliner.#aa * s2;
      this.#ta = s2;
      this.#ia.push(t2, e2);
    }
    isEmpty() {
  ...
  class ColorPicker {
    ...
    constructor({ editor: t2 = null, uiManager: e2 = null }) {
      ...
      ColorPicker.#Fa ||= Object.freeze({ blue: "pdfjs-editor-colorpicker-blue", green: "pdfjs-editor-colorpicker-green", pink: "pdfjs-editor-colorpicker-pink", red: "pdfjs-editor-colorpicker-red", yellow: "pdfjs-editor-colorpicker-yellow" });
    }
    renderButton() {
    ...
    #Oa() {
      ...
      for (const [i2, s2] of this.#m.highlightColors) {
        ...
        n2.title = i2;
        n2.setAttribute("data-l10n-id", ColorPicker.#Fa[i2]);
    ...
    #qs(t2) {
      ColorPicker._keyboardManager.exec(this, t2);
    }
    #La(t2) {
      if (this.#Ba) {
        this.hideDropdown();
  ...
  class HighlightEditor extends AnnotationEditor {
    ...
    static get _keyboardManager() {
      const t2 = HighlightEditor.prototype;
    ...
    constructor(t2) {
      ...
      this.color = t2.color || HighlightEditor._defaultColor;
      this.#ea = t2.thickness || HighlightEditor._defaultThickness;
      this.#Ka = t2.opacity || HighlightEditor._defaultOpacity;
    ...
    #Za({ highlightOutlines: t2, highlightId: e2, clipPathId: i2 }) {
      ...
      if (e2 >= 0) {
        ...
        this.parent.drawLayer.updateProperties(this.#w, { bbox: HighlightEditor.#ir(this.#qa.box, (e3 - this.rotation + 360) % 360), path: { d: t2.toSVGPath() } });
        this.parent.drawLayer.updateProperties(this.#Ya, { bbox: HighlightEditor.#ir(this.#$a.box, e3), path: { d: this.#$a.toSVGPath() } });
      }
    ...
    static initialize(t2, e2) {
      AnnotationEditor.initialize(t2, e2);
      HighlightEditor._defaultColor ||= e2.highlightColors?.values().next().value || "#fff066";
    }
    static updateDefaultParams(t2, e2) {
      switch (t2) {
        case m.HIGHLIGHT_DEFAULT_COLOR:
          HighlightEditor._defaultColor = e2;
          break;
        case m.HIGHLIGHT_THICKNESS:
          HighlightEditor._defaultThickness = e2;
      }
    }
    translateInPage(t2, e2) {
    }
    ...
    static get defaultPropertiesToUpdate() {
      return [[m.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor], [m.HIGHLIGHT_THICKNESS, HighlightEditor._defaultThickness]];
    }
    get propertiesToUpdate() {
      return [[m.HIGHLIGHT_COLOR, this.color || HighlightEditor._defaultColor], [m.HIGHLIGHT_THICKNESS, this.#ea || HighlightEditor._defaultThickness], [m.HIGHLIGHT_FREE, this.#Xa]];
    }
    #On(t2) {
      ...
      this.addCommands({ cmd: setColorAndOpacity.bind(this, t2, HighlightEditor._defaultOpacity), undo: setColorAndOpacity.bind(this, e2, i2), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: true, type: m.HIGHLIGHT_COLOR, overwriteIfSameType: true, keepUndo: true });
    ...
    rotate(t2) {
      ...
      if (this.#Xa) {
        ...
        i2 = HighlightEditor.#ir(this.#qa.box, t2);
      } else i2 = HighlightEditor.#ir([this.x, this.y, this.width, this.height], t2);
      e2.updateProperties(this.#w, { bbox: i2, root: { "data-main-rotation": t2 } });
      e2.updateProperties(this.#Ya, { bbox: HighlightEditor.#ir(this.#$a.box, t2), root: { "data-main-rotation": t2 } });
    }
    render() {
      if (this.div) return this.div;
      const t2 = super.render();
    ...
    #or(t2) {
      HighlightEditor._keyboardManager.exec(this, t2);
    }
    _moveCaret(t2) {
  ...
  class DrawingEditor extends AnnotationEditor {
    ...
    #Er(t2, e2) {
      const { id: i2 } = e2.drawLayer.draw(DrawingEditor._mergeSVGProperties(this._drawingOptions.toSVGProperties(), t2.defaultSVGProperties), false, false);
      return i2;
    }
    ...
    static updateDefaultParams(t2, e2) {
      ...
      if (this._currentParent) {
        DrawingEditor.#fr.updateProperty(i2, e2);
    ...
    _onResizing() {
      this.parent?.drawLayer.updateProperties(this._drawId, DrawingEditor._mergeSVGProperties(this.#gr.getPathResizingSVGProperties(this.#Cr()), { bbox: this.#Tr() }));
    }
    _onResized() {
      this.parent?.drawLayer.updateProperties(this._drawId, DrawingEditor._mergeSVGProperties(this.#gr.getPathResizedSVGProperties(this.#Cr()), { bbox: this.#Tr() }));
    }
    _onTranslating(t2, e2) {
      this.parent?.drawLayer.updateProperties(this._drawId, { bbox: this.#Tr(t2, e2) });
    }
    _onTranslated() {
      this.parent?.drawLayer.updateProperties(this._drawId, DrawingEditor._mergeSVGProperties(this.#gr.getPathTranslatedSVGProperties(this.#Cr(), this.parentDimensions), { bbox: this.#Tr() }));
    }
    _onStartDragging() {
    ...
    rotate() {
      this.parent && this.parent.drawLayer.updateProperties(this._drawId, DrawingEditor._mergeSVGProperties({ bbox: this.#Tr() }, this.#gr.updateRotation((this.parentRotation - this.rotation + 360) % 360)));
    }
    onScaleChanging() {
    ...
    static startDrawing(t2, e2, i2, s2) {
      ...
      if (DrawingEditor.#vr && DrawingEditor.#vr !== l2) return;
      const { viewport: { rotation: h2 } } = t2, { width: d2, height: c2 } = n2.getBoundingClientRect(), u2 = DrawingEditor.#br = new AbortController(), p2 = t2.combinedSignal(u2);
      DrawingEditor.#wr ||= o2;
      DrawingEditor.#vr ??= l2;
      window.addEventListener("pointerup", ((t3) => {
        DrawingEditor.#wr === t3.pointerId ? this._endDraw(t3) : DrawingEditor.#yr?.delete(t3.pointerId);
      }), { signal: p2 });
      window.addEventListener("pointercancel", ((t3) => {
        DrawingEditor.#wr === t3.pointerId ? this._currentParent.endDrawingSession() : DrawingEditor.#yr?.delete(t3.pointerId);
      }), { signal: p2 });
      window.addEventListener("pointerdown", ((t3) => {
        if (DrawingEditor.#vr === t3.pointerType) {
          (DrawingEditor.#yr ||= /* @__PURE__ */ new Set()).add(t3.pointerId);
          if (DrawingEditor.#fr.isCancellable()) {
            DrawingEditor.#fr.removeLastElement();
            DrawingEditor.#fr.isEmpty() ? this._currentParent.endDrawingSession(true) : this._endDraw(null);
          }
        }
      ...
      n2.addEventListener("touchmove", ((t3) => {
        t3.timeStamp === DrawingEditor.#xr && stopEvent(t3);
      }), { signal: p2 });
      t2.toggleDrawing();
      e2._editorUndoBar?.hide();
      if (DrawingEditor.#fr) t2.drawLayer.updateProperties(this._currentDrawId, DrawingEditor.#fr.startNew(a2, r2, d2, c2, h2));
      else {
        e2.updateUIForDefaultProperties(this);
        DrawingEditor.#fr = this.createDrawerInstance(a2, r2, d2, c2, h2);
        DrawingEditor.#Ar = this.getDefaultDrawingOptions();
        this._currentParent = t2;
        ({ id: this._currentDrawId } = t2.drawLayer.draw(this._mergeSVGProperties(DrawingEditor.#Ar.toSVGProperties(), DrawingEditor.#fr.defaultSVGProperties), true, false));
      }
    }
    static _drawMove(t2) {
      DrawingEditor.#xr = -1;
      ...
      if (DrawingEditor.#wr === s2) if (DrawingEditor.#yr?.size >= 1) this._endDraw(t2);
      else {
        this._currentParent.drawLayer.updateProperties(this._currentDrawId, DrawingEditor.#fr.add(e2, i2));
        DrawingEditor.#xr = t2.timeStamp;
        stopEvent(t2);
      }
    }
    static _cleanup(t2) {
    ...
    static _endDraw(t2) {
      ...
      if (e2) {
        ...
        this._cleanup(false);
        t2 && e2.drawLayer.updateProperties(this._currentDrawId, DrawingEditor.#fr.end(t2.offsetX, t2.offsetY));
        if (this.supportMultipleDrawings) {
          const t3 = DrawingEditor.#fr, i2 = this._currentDrawId, s2 = t3.getLastElement();
          e2.addCommands({ cmd: () => {
    ...
    static endDrawing(t2) {
      ...
      if (!DrawingEditor.#fr.isEmpty()) {
        const { pageDimensions: [i2, s2], scale: n2 } = e2, a2 = e2.createAndAddNewEditor({ offsetX: 0, offsetY: 0 }, false, { drawId: this._currentDrawId, drawOutlines: DrawingEditor.#fr.getOutlines(i2 * n2, s2 * n2, n2, this._INNER_MARGIN), drawingOptions: DrawingEditor.#Ar, mustBeCommitted: !t2 });
        this._cleanup(true);
        return a2;
      }
  ...
  class InkDrawingOptions extends DrawingOptions {
    ...
    clone() {
      const t2 = new InkDrawingOptions(this.#zr);
      t2.updateAll(this);
      return t2;
    }
  }
  class InkEditor extends DrawingEditor {
    ...
    createDrawingOptions({ color: t2, thickness: e2, opacity: i2 }) {
      this._drawingOptions = InkEditor.getDefaultDrawingOptions({ stroke: Util.makeHexColor(...t2), "stroke-width": e2, "stroke-opacity": i2 });
    }
    serialize(t2 = false) {
      if (this.isEmpty()) return null;
      if (this.deleted) return this.serializeDeleted();
  ...
  class StampEditor extends AnnotationEditor {
    ...
    #to() {
      ...
      t2.type = "file";
      t2.accept = StampEditor.supportedTypesStr;
  ...
  class AnnotationEditorLayer {
    ...
    constructor({ uiManager: t2, pageIndex: e2, div: i2, structTreeLayer: s2, accessibilityManager: n2, annotationLayer: a2, drawLayer: r2, textLayer: o2, viewport: l2, l10n: h2 }) {
      const d2 = [...AnnotationEditorLayer.#U.values()];
    ...
    updateMode(t2 = this.#m.getMode()) {
      ...
      for (const i2 of AnnotationEditorLayer.#U.values()) e2.toggle(`${i2._type}Editing`, t2 === i2._editorType);
    ...
    disable() {
      ...
      for (const t3 of AnnotationEditorLayer.#U.values()) i2.remove(`${t3._type}Editing`);
      this.disableTextSelection();
      this.toggleAnnotationLayerPointerEvents(true);
      this.#do = false;
    }
    ...
    async deserialize(t2) {
      return await AnnotationEditorLayer.#U.get(t2.annotationType ?? t2.annotationEditorType)?.deserialize(t2, this, this.#m) || null;
    }
  ...
  class DrawLayer {
    ...
    #Eo() {
      const t2 = DrawLayer._svgFactory.create(1, 1, true);
      this.#nn.append(t2);
    ...
    draw(t2, e2 = false, i2 = false) {
      const s2 = this.#w++, n2 = this.#Eo(), a2 = DrawLayer._svgFactory.createElement("defs");
      n2.append(a2);
      ...
      const l2 = i2 ? this.#So(a2, o2) : null, h2 = DrawLayer._svgFactory.createElement("use");
      n2.append(h2);
    ...
    drawOutline(t2, e2) {
      const i2 = this.#w++, s2 = this.#Eo(), n2 = DrawLayer._svgFactory.createElement("defs");
      s2.append(n2);
      const a2 = DrawLayer._svgFactory.createElement("path");
      n2.append(a2);
